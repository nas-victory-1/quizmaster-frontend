        ...
        <TabsContent value="appearance" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Customize how QuizMaster looks and feels</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-base font-medium">Theme</Label>
                  <p className="text-sm text-gray-500">Choose your preferred theme</p>
                  <Select value={appearance.theme} onValueChange={(value: any) => updateAppearance("theme", value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: any) => updateAppearance("timeFormat", value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
