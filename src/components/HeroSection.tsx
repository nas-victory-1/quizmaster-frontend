      ...
      <div className="container grid gap-8 md:grid-cols-2 items-center">
        <div className="space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">
            ...
            <span className="text-purple-600">AI assistance</span>
          </h1>
          <p className="text-lg text-gray-600">
            Build interactive quizzes, share with participants, and analyze
            results in real-time. Let AI help you generate questions or organize
            existing ones.
          </p>
