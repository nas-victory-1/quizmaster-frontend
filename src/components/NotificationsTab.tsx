          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Get reminded about upcoming scheduled quizzes
                </p>
              </div>
              <Switch
                checked={notifications.quizReminders}
                onCheckedChange={(checked) =>
                  updateNotifications("quizReminders", checked)
                }
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Notify when someone joins your quiz
                </p>
              </div>
              <Switch
                checked={notifications.participantJoined}
                onCheckedChange={(checked) =>
                  updateNotifications("participantJoined", checked)
                }
                disabled={!notifications.emailNotifications}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Notify when your quiz is completed
                </p>
              </div>
              <Switch
                checked={notifications.quizCompleted}
                onCheckedChange={(checked) =>
                  updateNotifications("quizCompleted", checked)
                }
                disabled={!notifications.emailNotifications}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateNotifications("marketingEmails", checked)
                }
                disabled={!notifications.emailNotifications}
              />
            </div>
